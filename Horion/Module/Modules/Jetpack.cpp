...
Jetpack::Jetpack() : IModule('F', Category::MOVEMENT, "Fly around like you had a Jetpack! (Speed 6 is double the old speed!)") {
	registerFloatSetting("speed", &this->speedMod, 1, 0.2f, 3.f, 6.f);
